            ...
            <div class="column-2">
                <div class="row-1">
                    ...
                    <?php if(have_rows("services")):?>
                        <div class="services clear-bottom">
                            <?php while(have_rows("services")): the_row();
                                $title = get_sub_field("service_title");
                                $anchor = get_sub_field("anchor_link");?>
                                <div class="service js-blocks">
                                    <?php if(exists($title)):?>
                                        <header><h3><?php echo $title;?></h3></header>
                                    <?php endif;?>
                                    <?php if(exists($anchor)):?>
                                        <a class="surrounding" href="<?php echo get_the_permalink(18);
